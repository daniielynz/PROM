...
class Actividad6 : AppCompatActivity() {
    ...
    fun accionCompletado(v: View) {
        ...
        val letra = resources.getStringArray(R.array.arrayLetrasActividades).getOrNull(5)?.trim()?.toString() ?: ""
        val puntos = resources.getStringArray(R.array.arrayPuntosActividades).getOrNull(5)?.trim()?.toString() ?: ""
        ...
        generarDialogo(v, getString(R.string.tituloGenerarDialogo), mensaje) {
            ...
            val valorVariable = sharedPreferences.getInt("ACTIVIDAD_6", 0)
            if (valorVariable == 0) {
                // Poner ACTIVIDAD_6 con valor 1
                val editor = sharedPreferences.edit()
                editor.putInt("ACTIVIDAD_6", 1)
                editor.apply()
                ...
                if (idUsuarioActual != -1L) {
                    ...
                    if (usuarioActual != null) {
                        ...
                        dbOperations.updateActividad(idUsuarioActual, 6)
