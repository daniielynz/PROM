...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Cargar usuario o mostrar dialog para generarlo
    ...
    //Crear usuario + Información en BBDD y SharedPreferences
    ...
    //Vaso habla y se muestra texto -> permite pulsar el texto mostrado (modificar por botón)
    ...
    //Crear usuarios por defecto en base de datos
