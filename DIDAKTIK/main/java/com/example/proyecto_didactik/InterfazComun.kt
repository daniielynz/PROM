...
class InterfazComun : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapaDeListas = mapOf(
            ...
            "Portu Zaharra" to listOf(getString(R.string.mision3), getString(R.string.descripcion3), "portu_zaharra","Actividad3"),
            "Portu zaharreko jaiak" to listOf(getString(R.string.mision4), getString(R.string.descripcion4), "portu_zaharreko_jaiak","Actividad4"),
            "Punta Begoña" to listOf(getString(R.string.mision5), getString(R.string.descripcion5), "punta_begona","Actividad5"),
            "Jose Luis de Ugarte" to listOf(getString(R.string.mision6), getString(R.string.descripcion6), "jose_luis","Actividad6"),
            "Bizkaiko zubia" to listOf(getString(R.string.mision7), getString(R.string.descripcion7), "bizkaiko_zubia","Actividad7"),
            "Abestia" to listOf(getString(R.string.misionCancion), getString(R.string.descripcionCancion), "getxoko_mamboa","Abestia")
        )
